...
//	
	...
	void testCreateAccount() {
		RestAssured.baseURI="http://65.2.123.255:8082/CreateAccount";
	...
	void testGetAccountDetails() {
		RestAssured.baseURI="http://65.2.123.255:8082/ViewAccount";
		RequestSpecification httpRequest = RestAssured.given();
	...
	void testUpdateAccountDetails() {
		RestAssured.baseURI="http://13.127.141.134:8082/UpdateAccount";
		RequestSpecification httpRequest = RestAssured.given();
